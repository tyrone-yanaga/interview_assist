...
def test_has_access_to_transcription(self, transcription_service, mock_db, mock_transcription, mock_user, mock_audio):
    ...
    with mock.patch("services.transcription_service.get_audio_or_404") as mock_get_audio:
        ...
        def debug_side_effect(*args, **kwargs):
            ...
            print(f"get_audio_or_404 called from: {caller_frame.filename}:{caller_frame.lineno}")
        ...
        # For positional arguments, don't use parameter names in assert_called_once_with
        ...
        with mock.patch("services.transcription_service.get_audio_or_404") as mock_get_audio:
            ...
            mock_get_audio.assert_called_once_with(
                db=mock_db, audio_id=mock_transcription.audio_id, user_id=999
            )